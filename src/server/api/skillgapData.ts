export const ROLE_SKILLS: Record<string, { skill: string; required: number; category: string }[]> = {
  ...
  'DevOps Engineer': [
    ...
    { skill: 'CI/CD Pipelines', required: 85, category: 'Automation' },
    { skill: 'Linux / Bash', required: 80, category: 'OS' },
    { skill: 'Monitoring', required: 70, category: 'Observability' },
    { skill: 'Git', required: 85, category: 'Tools' },
  ...
  'Product Manager': [
    ...
    { skill: 'SQL / Analytics', required: 65, category: 'Data' },
  ...
  'Cloud Architect': [
    ...
    { skill: 'Monitoring', required: 75, category: 'Operations' },
