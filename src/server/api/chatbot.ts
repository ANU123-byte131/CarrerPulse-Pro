...
function generateResponse(message: string, profile: any): string {
  ...
  else if (lower.includes('job') || lower.includes('apply') || lower.includes('search') || lower.includes('hire') || lower.includes('work')) category = 'job';
  ...
  if (profile?.targetRole) {
    response = response.replace('your core area', `${profile.targetRole}`);
    if (category === 'default') {
